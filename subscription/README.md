...
The following *<b>creates an SQLite3 database</b>* in a new file at db/development.sqlite3 and runs the change method from the latest migration to *<b>create the students table</b>* in the database. 
